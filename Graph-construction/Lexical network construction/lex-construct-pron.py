...
dutchdata = pd.read_csv("/users/grad/rsaha/Rusali/Data/syll_french_full_pron.txt", sep=" ",error_bad_lines=False)
...
dutchdata = dutchdata.rename(columns={'O1t1E1R':'words', 'O$t1E1R':'syllables'})
